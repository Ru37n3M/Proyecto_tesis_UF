...
deal_A_s_oi <- function(p, k_n) {
  ...
  repeat { #loop de repeticion
    ...
    par <- participantes[p] #orden de entrada secuencial de participantes (1 en 1)
    
    assign("participantes", participantes[-p], envir = globalenv()) #se modifica el vector participantes creado a partir
...
deal_A_s_oi(1, 5) #retorna dataframe con visualizaciones y votos del total de participantes
