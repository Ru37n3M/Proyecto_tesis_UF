...
generador_graficos <- function(dislist, parametros_simulacion_df){
  ...
  ggsave("b.png",  height = 60, width = 30, units = 'cm')
  ...
  ggsave("a.png",  height = 60, width = 30, units = 'cm')
  ...
  ggsave("c.png",  height = 60, width = 30, units = 'cm', path ='C:\\Users\\enioy\\OneDrive\\Documentos\\R\\Graficos\\Tesis\\Resultados_sim')
  ...
  ggsave("d.png",  height = 60, width = 30, units = 'cm')
  ...
  ggsave("e.png",  height = 60, width = 30, units = 'cm')
  ...
  ggsave("f.png",  height = 60, width = 30, units = 'cm')
