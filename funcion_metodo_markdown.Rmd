...
El orden de entrada de los agentes y los numeros de identificacion de cada sujeto (ID) estan generados a partir de la funcion `shuffle_dist`. Ejemplificamos aca 

```{r}
shuffle_dist(dist) %>% head()
```

El orden de entrada es el orden de las filas del dataframe resultante a partir de esta funcion. 
